...
$data               = @$this->_data['pagination_cate'];

$inputId            = ZMOVIES_SETTING_OPTION . '[pagination_cate][page_mid_size]';
$value              = (!empty(@$data['page_mid_size'])) ? @$data['page_mid_size'] : 5;
$videoPageMidSize   = $htmlObj->textbox($inputId,$value,['class'=>'regular-text']);

$inputId            = ZMOVIES_SETTING_OPTION . '[pagination_cate][page_end_size]';
...
$inputId            = ZMOVIES_SETTING_OPTION . '[pagination_cate][first_post_per_page]';
...
$inputId            = ZMOVIES_SETTING_OPTION . '[pagination_cate][page_limit_scroll]';
...
$inputId            = ZMOVIES_SETTING_OPTION . '[pagination_cate][posts_per_page]';
...
$inputId            = ZMOVIES_SETTING_OPTION . '[pagination_cate][page_load_type]';
...
$lbl 	= __('Category', ZMOVIES_DOMAIN_LANGUAGE);
?>
