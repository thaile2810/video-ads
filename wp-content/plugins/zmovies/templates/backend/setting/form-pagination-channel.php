...
$data               = @$this->_data['pagination_channel'];

$inputId            = ZMOVIES_SETTING_OPTION . '[pagination_channel][page_mid_size]';
$value              = (!empty(@$data['page_mid_size'])) ? @$data['page_mid_size'] : 5;
$videoPageMidSize   = $htmlObj->textbox($inputId,$value,['class'=>'regular-text']);

$inputId            = ZMOVIES_SETTING_OPTION . '[pagination_channel][page_end_size]';
...
$inputId            = ZMOVIES_SETTING_OPTION . '[pagination_channel][first_post_per_page]';
...
$inputId            = ZMOVIES_SETTING_OPTION . '[pagination_channel][page_limit_scroll]';
...
$inputId            = ZMOVIES_SETTING_OPTION . '[pagination_channel][posts_per_page]';
...
$inputId            = ZMOVIES_SETTING_OPTION . '[pagination_channel][page_load_type]';
...
$lbl 	= __('Channel', ZMOVIES_DOMAIN_LANGUAGE);
?>
