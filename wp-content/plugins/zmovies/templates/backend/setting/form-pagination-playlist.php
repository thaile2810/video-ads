...
$data               = @$this->_data['pagination_playlist'];

$inputId            = ZMOVIES_SETTING_OPTION . '[pagination_playlist][page_mid_size]';
$value              = (!empty(@$data['page_mid_size'])) ? @$data['page_mid_size'] : 5;
$videoPageMidSize   = $htmlObj->textbox($inputId,$value,['class'=>'regular-text']);

$inputId            = ZMOVIES_SETTING_OPTION . '[pagination_playlist][page_end_size]';
...
$inputId            = ZMOVIES_SETTING_OPTION . '[pagination_playlist][first_post_per_page]';
...
$inputId            = ZMOVIES_SETTING_OPTION . '[pagination_playlist][page_limit_scroll]';
...
$inputId            = ZMOVIES_SETTING_OPTION . '[pagination_playlist][posts_per_page]';
...
$inputId            = ZMOVIES_SETTING_OPTION . '[pagination_playlist][page_load_type]';
...
$lbl 	= __('Playlist', ZMOVIES_DOMAIN_LANGUAGE);
?>
