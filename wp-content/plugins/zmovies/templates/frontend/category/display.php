<?php 
    ...
    $videoUrl    = get_post_meta(get_the_ID(), $modelVideo->metaKey('url') ,true);
    $videoId     = str_replace('https://www.youtube.com/watch?v=', '', $videoUrl);
    $imgUrl      = ZMOVIES_FILE_URL . '/video/thumb' . $videoId . '/default.jpg';
    $imgPath     = ZMOVIES_FILE_PATH . DS . 'video' . DS . 'thumb' . $videoId . DS . 'sddefault.jpg';
    $imgHtml     = '';
    if(file_exists($imgPath)){
        $imgHtml = '<a href="' . get_the_permalink() . '"><img src="' . $imgUrl . '"></a>';
    }
