...
class CronjControl {
    ...
    private function __construct($plugin_file = null, $options = null) {
        self::$instance = $this;
    ...
    public static function getInstance($params = null, $options = null){
        if (self::$instance === null) {
            self::$instance = new self($params = null, $options = null);
        }
